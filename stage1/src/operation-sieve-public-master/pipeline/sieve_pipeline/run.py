...
from sieve_pipeline import PipelineRemote, PipelineLocal, PipelineKube
...
def cli_args():
    ...
    run_group = parser.add_argument_group(
        "Running", "Options that modify how sieve runs"
    )
...
def main():
    ...
    pipeline = pipeline_class(
        ...
        is_sieve=args.is_sieve or args.is_full,
